...
const translations = {
  ar: {
    ...
    summary_desc: "تعتبر منصة Make.com الخيار الأول والموصى به لغالبية الأعمال بفضل الجمع بين التكلفة المنخفضة جداً والمحرر المرئي القوي الذي يتفوق على منافسيه. إذا كنت تبحث عن السهولة المطلقة بدون كود وبميزانية كبرى فـ Zapier خيار ممتاز، بينما n8n مثالي فقط للمبرمجين الراغبين بالاستضافة الذاتية.",
